...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      ...
      <span class="brand-text font-weight-light">CoreBilişim</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/yemek'); ?>" class="nav-link <?php active("yemek"); ?>">
                  <i class="fas fa-hamburger nav-icon"></i>
                  <p>Yemek Ekle</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/icecek'); ?>" class="nav-link <?php active("icecek"); ?>">
                  <i class="fas fa-coffee nav-icon"></i>
                  <p>İçecek Ekle</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/tatli'); ?>" class="nav-link <?php active("tatli"); ?>">
